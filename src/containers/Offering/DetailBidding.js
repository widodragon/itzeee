...
class DetailBidding extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fullname   : '',
    ...
    return (
      <View style={styles.container}>
                ...
                <FlatList
                  ...
                  <View>
                    <TouchableNativeFeedback onPress={() =>{}} >
                      <View style={{width:imgX(15), marginRight:hp(1), justifyContent:"center", alignItems:"center", height:imgY(15), borderRadius:imgY(15/2), backgroundColor:"blue"}}> 
        ...
        <View style={{flex:0.2, backgroundColor:"black"}}>
          <View style={{flex:1, flexDirection:"column", alignSelf:"center", width:"90%"}}>
            <View style={{flex:0.5, paddingTop:hp(2), paddingBottom:hp(1), justifyContent:"space-between", flexDirection:"row"}}>
              <Text style={{color:"white", fontSize:hp(2.3)}}>Total Pendapatan</Text>
              <Text style={{color:"white", fontSize:hp(2.3)}}>Rp 2.400.000</Text>
            </View>
            <TouchableOpacity style={{flex:0.5, backgroundColor:"blue", justifyContent:"center", alignItems:"center", width:"100%", paddingTop:hp(1), paddingBottom:hp(1), borderRadius:hp(2), marginBottom:hp(2)}}>
                <Text style={{color:"white", fontSize:hp(2.3)}}>Ambil Pekerjaan</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
...
export default connect(mapStateToProps)(DetailBidding)