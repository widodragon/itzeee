          ...
          <View style={{width:"90%", alignSelf:"center", marginTop:hp(2)}}>
            <View style={{backgroundColor:"white", paddingTop:hp(1),paddingBottom:hp(1), flexDirection:"row", borderRadius:hp(1), marginBottom:hp(2)}}>
              ...
              <View style={{flex:0.95, justifyContent:"center"}}>
                <Picker selectedValue = {this.state.religious} onValueChange = {this.updateReligious}>
                   <Picker.Item color="grey" label = "Penawaran Terbaru" value = "Proses" />
            ...
            <FlatList
              ...
              <View style={{borderRadius:hp(1), marginBottom:hp(2)}}>
                ...
                <TouchableOpacity style={{borderBottomLeftRadius: hp(1),borderBottomRightRadius: hp(1),justifyContent:"center", alignItems:"center", paddingBottom:hp(2), paddingTop:hp(2), backgroundColor:"blue"}}>
                  <Text style={{fontSize:hp(2), color:"white"}}>Proses Bidding</Text>
                </TouchableOpacity>
              </View>
              }
...
export default connect(mapStateToProps)(Proses)