      ...
      <Container style={{flex:1,backgroundColor:"#e3e1e1"}}>
        <View style={{flex:0.1, width:"90%", flexDirection:"row", paddingTop:hp(2), paddingBottom:hp(2), alignSelf:"center",borderRadius:hp(0.5), backgroundColor:"white", marginTop:hp(2)}}>
            ...
            <View style={{flex:0.8, flexDirection:"column", justifyContent:"center"}}>
              <Text style={{fontSize:hp(2.5)}}>Penambahan</Text>
        ...
        <View style={{flex:0.2, paddingRight:wp(5), paddingLeft:wp(5), borderBottomWidth:1, borderColor:"#e3e1e1", width:"90%", flexDirection:"column", paddingTop:hp(2), paddingBottom:hp(2), alignSelf:"center",borderRadius:hp(0.5), backgroundColor:"white", marginTop:hp(0.1)}}>
          ...
          <View style={{flex:0.3,paddingBottom:hp(1), paddingTop:hp(1), flexDirection:"row", justifyContent:"space-between"}}>
            <Text style={{fontSize:hp(2)}}>Nomor Invoice</Text>
            <Text style={{fontSize:hp(2)}}>#2341232321</Text>
          </View>
          <View style={{flex:0.3,paddingBottom:hp(1), paddingTop:hp(1), flexDirection:"row", justifyContent:"space-between"}}>
            <Text style={{fontSize:hp(2)}}>ID Transaksi</Text>
            <Text style={{fontSize:hp(2)}}>ID #4342423</Text>
          </View>
        </View>
...
export default connect(mapStateToProps)(DetailDeposit)